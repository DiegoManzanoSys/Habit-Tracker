    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={[styles.subtitle, { color: theme.text }]}>Crea una cuenta para comenzar</Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={() => router.push("/login")}>
            <Text style={[styles.linkText, { color: theme.accent }]}>¿Ya tienes una cuenta? Inicia sesión</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
